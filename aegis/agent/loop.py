...
from aegis.agent.tools.filesystem import ReadFileTool, WriteFileTool, EditFileTool, ListDirTool
from aegis.agent.tools.shell import ExecTool
from aegis.agent.tools.web import WebSearchTool, WebFetchTool
from aegis.agent.tools.message import MessageTool
from aegis.agent.tools.spawn import SpawnTool
...
class AgentLoop:
    ...
    def __init__(
        ...
        from aegis.config.schema import ExecToolConfig
